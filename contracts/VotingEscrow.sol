...
contract VotingEscrow is Initializable, IVotingEscrow, IVotes {
    ...
    string public constant name = "veJungl";
    string public constant symbol = "veJungl";
    ...
    function _burn(uint256 _tokenId) internal {
        require(
            _isApprovedOrOwner(msg.sender, _tokenId) ||
                IVoter(voter).isBribe(msg.sender),
    ...
    function _deposit_for(
        ...
        LockedBalance memory old_locked;
        (old_locked.amount, old_locked.end) = (
    ...
    function deposit_for(
        ...
        require(
            locked_balance.end > block.timestamp,
    ...
    function _create_lock(
        ...
        uint256 unlock_time = ((block.timestamp + _lock_duration) /
            EPOCH_DURATION) * EPOCH_DURATION; // Locktime is rounded down to weeks
    ...
    function increase_unlock_time(
        ...
        require(
            unlock_time > locked_balance.end,
